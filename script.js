function carregaDicionario() {
    ...
    for (var bio in biografias) {
        console.innerHTML +=
            ...
            "</summary>" + "<p>" + biografias[bio].descricao + "</p>" 
            +  "<p>" + biografias[bio].citacao + "</p>" + 
            "</details>" + "</div>";
        }

    var footer = {
        foot: {
            footertexto: "Página desenvolvida como exercício do curso Front-End 2, PrograMaria, por ",
            footerlink: "https:www.linkedin.com/in/patriciapassosamaral",
            footertexto2: "Patrícia Passos",
        }

    }   
    
    for (var foot in footer) {
        console.innerHTML += 
            footer[foot].footertexto + 
            "<aref>" + 
            footer[foot].footerlink + 
            '" ' + 
            footer[foot].footertexto2 + 
            "</a>" + 
            "</div>";
    }
}
